...
export default class ChatRoom extends Listenable {
    ...
    constructor(connection, jid, password, xmpp, options) {
        ...
        this.eventsForwarder = new EventEmitterForwarder(this.connection.moderator, this.eventEmitter);
    ...
    join(password, replaceParticipant) {
        ...
        return new Promise(resolve => {
            ...
            const preJoin
                = this.options.disableFocus
                    ? Promise.resolve()
                    : this.connection.moderator.sendConferenceRequest(this.roomjid);
    ...
    sendPresence(fromJoin) {
        ...
        if (fromJoin) {
            ...
            if (this.connection.moderator.targetUrl) {
    ...
    onPresence(pres) {
        ...
        member.jid = jid;
        member.isFocus = this.connection.moderator.isFocusJid(jid);
